...
This dataset belongs to a fictious company named Maven Marketing Company. It data contains a table with 2,240 records and 27 columns which covers information about five different campaigns carried out by the company in order to improve its sales. The original dataset can be found here.

## Project Objectives 
The goal of this comprehensive marketing analysis is to unravel the hidden insights within the company’s data by uncovering consumer behavior pattern, assessing the campaigns effectiveness to optimize marketing strategies, and ultimately enabling Maven to make well-informed data-driven decisions.

## Data Analysis Process
In data analysis, there is a set of highly significant processes that must be followed meticulously in order to achieve accurately processed data with an end result of reliable and useful analysis. Here are the steps I took in order to analyze this dataset:
...
2.	What Are Customer Preferences and Trends: Identifying patterns in consumer behavior, preferences, and engagement. Understanding how customers interact with the company’s products can provide valuable insights into tailoring marketing strategies to meet their needs.Which of the products generated the highest profit, and which one generated the lowest?
...
4.	Does the overall income of an household have any effect on the purchasing power of the family?
5.	Does customers' education level influence the medium of purchase?
6.	Any other data-driven insights into the sales data.
...
Data exploration is a crucial data analysis procedure that involves delving into the dataset to gain a deeper understanding of its structure, contents, patterns, and potential relationships. It is an essential step that helps analysts identify trends, anomalies, and insights that may not be immediately apparent. Data exploration lays the foundation for subsequent analysis by providing context and guiding the formulation of hypotheses and strategies. So upon getting the dataset, I explored to verify that it is relevant and is in alignment with the business question. After thorough inspection, I discovered that the dataset has many quality issues including duplicate values, missing values, and outliers. I took the following steps to ensure data quality and integrity:

1.	Removed duplicate values and blank cells.
2.	Replaced “Graduation” with “graduate” in the Education column.
...
4.	Changed the products price columns which were formatted as “text” to “currency” format.
   
## Data Analysis 
1.	I created a new column named “Age Category” which grouped the age column into three age ranges: Young Adult, Middle Age, and Old. 
2.	I created a new column named “Age” which I calculated from the “Birth” column in order to delve in to the different age bracket of the customers, which was very essential in analyzing customer demographic data. 
...
The Channel Performance Comparison was an analysis made between the three channels used by Maven Marketing for sales: web, catalogue, and store. In the course of my analysis, I discovered that the store performance was the most successful channels contributing a significant of 46% of total sales, in contrast to the Web and Catalogue channels which had 33% and 21% respectively. This insight underscores the importance of the store channel and its impact on the company’s sales dynamics. Further questions like “does customer's age or education level influence the medium of purchase?” revealed the reasons for the attributed success and failure of each channel.
...
# Which of the marketing campaigns was the most successful according to customers response? 
